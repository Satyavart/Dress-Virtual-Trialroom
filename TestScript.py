...
front = "C:/Class notes/New folder/abcdef/tucked1.jpg"
bent = "C:/Class notes/New folder/abcdef/tucked2.jpg"
back = "C:/Class notes/New folder/abcdef/tucked3.jpg"
...
Original_Image = Image.open("C:/Class notes/New folder/abcdef/tucked2.png").convert('RGBA')
...
shirt_image = Image.open('C:/Class notes/New folder/abcdef/transparent1.png').convert('RGBA')
...
# save the image
Original_Image_Copy.save('C:/Class notes/New folder/abcdef/output_maybe_success.png', format='png')

# img = cv2.imread('output_maybe_success.png')
# imgplot = plt.imshow(img)
# plt.show()
img = cv2.imread('C:/Class notes/New folder/abcdef/output_maybe_success.png')
path = 'C:/Class notes/New folder/abcdef/'
